...
<head>
  	...
  	<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/js/lib/jquery.pageslide.css" />
  	<style>
...
&lt;a href=&quot;javascript:$.pageslide({ direction: &#39;left&#39;, href=&#39;_secondary.html&#39; })&quot;&gt;Link text&lt;/a&gt;
    ...
    <script src="<?php bloginfo('template_url'); ?>/js/lib/jquery-1.7.1.min.js"></script>
    <script src="<?php bloginfo('template_url'); ?>/js/lib/jquery.pageslide.min.js"></script>
    <script>
